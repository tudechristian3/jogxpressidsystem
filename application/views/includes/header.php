...
<meta itemprop="image" content="<?php echo base_url()?>s3.amazonaws.com/creativetim_bucket/products/72/opt_nudp_thumbnail.jpg">
...
<meta name="twitter:image" content="<?php echo base_url()?>s3.amazonaws.com/creativetim_bucket/products/72/opt_nudp_thumbnail.jpg">
...
<meta property="og:image" content="<?php echo base_url()?>s3.amazonaws.com/creativetim_bucket/products/72/opt_nudp_thumbnail.jpg"/>
...
<link rel="stylesheet" href="<?php echo base_url('assets')?>/use.fontawesome.com/releases/v5.7.1/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
<!-- CSS Files -->
<link href="<?php echo base_url()?>assets/css/bootstrap.min.css" rel="stylesheet" />
<link href="<?php echo base_url()?>assets/css/now-ui-dashboard.minaa26.css?v=1.5.0" rel="stylesheet" />
...
<link href="<?php echo base_url('assets/')?>js/dist/sweetalert2.min.css" rel="stylesheet">
    </head>